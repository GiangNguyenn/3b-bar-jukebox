...
export function GenresSelector({ selectedGenres, onGenresChange }: GenresSelectorProps): JSX.Element {
                    ...
                    <Combobox.Option
                      ...
                      className={({ active }) =>
                        `relative cursor-pointer select-none py-2 pl-10 pr-4 ${
                          active ? 'bg-accent/50 text-accent-foreground' : 'text-foreground hover:bg-accent/20'
                        }`
                      }
                    >
                      {({ selected, active }) => (
