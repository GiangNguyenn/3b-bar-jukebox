        ...
        >
            <div className='max-h-96 space-y-1 overflow-y-auto rounded bg-black/50 p-2 font-mono text-xs'>
                {internalLogs.map((log, index) => (
                    <div key={`${log.timestamp}-${index}`} className='border-b border-white/5 pb-1 last:border-0 last:pb-0'>
                        ...
                        {log.details != null && (
                            <pre className='mt-1 overflow-x-auto whitespace-pre-wrap text-gray-500 pl-24'>
